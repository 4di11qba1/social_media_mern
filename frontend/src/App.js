  ...
  return (
    <div className="App">
      <MyThemeProvider darkMode={darkMode}>
        <div
          className={`animation ${showAnimation ? "show" : ""}`}
          style={{ backgroundColor: "black" }}
        ></div>
        {showAnimation ? null : (
          <>
            {user && (
              <MiniDrawer darkMode={darkMode} changeMode={changeDarkMode} />
            )}
            <Routes>
              <Route
                path="/"
              ...
              />
              <Route path="/game" element={user ? <Game /> : <Auth />} />
              <Route
                path="/profile/:id"
              ...
              <Route
                ...
                element={
                  user ? (
                    <Main itemData={itemData} itemDataV={itemDataV} />
                  ) : (
                    <Navigate to="../auth" />
                  )
                }
              ...
              <Route
                ...
                element={
                  user ? (
                    <Library itemData={itemData} itemDataV={itemDataV} />
                  ) : (
                    <Navigate to="../auth" />
                  )
                }
